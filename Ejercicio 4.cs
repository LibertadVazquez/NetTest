...
que unifique los métodos 
Crear un abstract BaseEntity que defina la property Id y luego modificar las entities Caja y Sucursal para que hereden 
de BaseEntity 
...
namespace Domain.Entities
{
    ...
    public class Sucursal : BaseEntity
    {
        ...
        public Sucursal(int id, string direccion, string telefono, Caja cc)
        {
            Id = id;
            Direccion = direccion;
            Telefono = telefono;
...
namespace Infrastructure.Data.Repositories
{
    ...
    {
        private readonly DataContext _db;
        public SucursalRepository(DataContext db)
            => _db = db;
...
public class BaseRepository<T> : CajaRepository, SucursalRepository
{
}
